...
public class AssetLoader {
    ...
    public static BufferedImage dirtTile = ImageLoader.loadImage("/textures/dirtTile.png");
    public static BufferedImage metalTile = ImageLoader.loadImage("/textures/metalTile.jpg");
