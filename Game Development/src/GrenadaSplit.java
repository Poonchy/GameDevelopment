...
public class GrenadaSplit extends Upgrade {
	...
	public static void makeGrenade(int xposition, int yposition) {
	    ...
	    timer.schedule(new TimerTask() {
	        ...
	        public void run() {
	        	Grenada.grenadecd += 3;
	        	Grenade.makeGrenade(Grenade.grenadelist.peek().LocalX, Grenade.grenadelist.peek().LocalY, 30, -100);
	        	Grenade.makeGrenade(Grenade.grenadelist.peek().LocalX, Grenade.grenadelist.peek().LocalY, 10, -100);
	        	Grenade.makeGrenade(Grenade.grenadelist.peek().LocalX, Grenade.grenadelist.peek().LocalY, 0, -50);
